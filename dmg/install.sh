...
cryptexctl  personalize --replace -o ~/security-research-device-main/example-cryptex --variant=research ~/security-research-device-main/example-cryptex/com.example.cryptex.cxbd
